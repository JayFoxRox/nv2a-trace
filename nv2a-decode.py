...
if True:
  ...
  shaderclipmode = read_word(nv2a_mem, 0x401994)
  #shaderctl = read_word(nv2a_mem, 0x401998) #FIXME
  shaderprog = read_word(nv2a_mem, 0x40199C)
...
if True:
  ...
  for i in range(4):
    offset = read_word(nv2a_mem, 0x401A24 + i * 4) # NV_PGRAPH_TEXOFFSET0
    ctl1 = read_word(nv2a_mem, 0x4019DC + i * 4) # NV_PGRAPH_TEXCTL1_0
    fmt = read_word(nv2a_mem, 0x401A04 + i * 4) # NV_PGRAPH_TEXFMT0
    ...
    ctl0 = read_word(nv2a_mem, 0x4019CC + i * 4)
    ...
    filter0 = read_word(nv2a_mem, 0x4019F4 + i * 4) # NV_PGRAPH_TEXFILTER0
    ...
    imagerect = read_word(nv2a_mem, 0x401A14 + i * 4) # NV_PGRAPH_TEXIMAGERECT0
    ...
    address = read_word(nv2a_mem, 0x4019BC + i * 4) # NV_PGRAPH_TEXADDRESS
